  ...
  <div class="container body">
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <form class="form-register" name="register" method="post" action="AddClient">
          <fieldset>
              ...
              <div class="form-group d-md-flex align-items-md-center">
                  ...
                  <div class="col-md-5">
                      ...
                      id="email" placeholder="Email" minlength="10" maxlength="40" name="email" required>
                  </div>
              ...
              <div class="form-group d-md-flex align-items-md-center">
                  ...
                  <div class="col-md-5">
                      ...
                      onkeyup="checkPhone(this)" name="phoneNumber" required>
                  </div>
