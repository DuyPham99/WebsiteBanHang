                     ...
                     <div class="row align-items-center no-gutters">
                         ...
                         <div class="col-lg-5 col-md-8 ml-auto mr-auto col-10">
                             <div class="categorie-search-box">
                                 <form action="#">
                                     <input type="text" name="search" placeholder="Tìm kiếm sản phẩm">
                         ...
                         <div class="col-lg-4 col-md-12">
                             <div class="cart-box mt-all-30">
                                 <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                                     <li><a href="#"><i class="lnr lnr-cart"></i><span class="my-cart"><span class="total-pro">2</span><span>Giỏ hàng</span></span></a>
                                         <ul class="ht-dropdown cart-box-width">
                                             <li>
                                                 <!-- Cart Box Start -->
                                                 <div class="single-cart-box">
                                                     <div class="cart-img">
                                                         <a href="#"><img src="img/products/a.jpg" alt="cart-image"></a>
                                                         <span class="pro-quantity">1X</span>
                                                     </div>
                                                     <div class="cart-content">
                                                         <h6><a href="product.html">Dầu gội đầu Sunsilk </a></h6>
                                                 ...
                                                 <div class="single-cart-box">
                                                     <div class="cart-img">
                                                         <a href="#"><img src="img/products/b.jpg" alt="cart-image"></a>
                                                         <span class="pro-quantity">1X</span>
                                                     </div>
                                                     <div class="cart-content">
                                                         <h6><a href="product.html">Dầu gội đầu Panties</a></h6>
                                                 ...
                                                 <div class="cart-footer">
                                                    <ul class="price-content">
                                                        <li>Tổng tiền <span>$57.95</span></li>
                                                        <li>Phí ship <span>$7.00</span></li>
                                                    </ul>
                                                     <div class="cart-actions text-center">
                                                         <a class="cart-checkout" href="checkout.html">Kiểm tra</a>
                                                     </div>
                                                 </div>
                                     ...
                                     <li><a href="register.html"><i class="fa fa-user-plus" aria-hidden="true"></i>    Đăng kí</a>
                                     </li>
                                     <li><a href="login.html"><i class="fa fa-user" aria-hidden="true"></i>    Đăng nhập</a>
                                     </li>
                         ...
                         <div class="col-xl-12 col-lg-12 col-md-12 ">
                            <nav class="d-none d-lg-block">
                                <ul class="header-bottom-list d-flex roboto">
                                    <li><a href="index-4.html"  style="font-size: 20px;">Trang chủ</a></li>
                                    <li><a href="about.html" style="font-size: 20px;">Giới thiệu</a></li>
                                    <li><a href="#" style="font-size: 20px;">Mẫu tóc<i class="fa fa-angle-down"></i></a>
                                        <!-- Home Version Dropdown Start -->
                                        <ul class="ht-dropdown dropdown-style-two">
                                            <li><a href="men.html" style="font-size: 20px;">Mẫu tóc nam</a></li>
                                            <li><a href="women.html" style="font-size: 20px;">Mẫu tóc nữ</a></li>
                                        </ul>
                                        <!-- Home Version Dropdown End -->
                                    </li>
                                    <li><a href="single-blog.html" style="font-size: 20px;">Blog</a></li>
                                    <li><a href="contact.html" style="font-size: 20px;">Phản hồi</a></li>
                                </ul>
                            </nav>
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        <li><a href="index-4.html">Trang chủ</a></li>
                        <li class="active"><a href="register.html">Đăng kí</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
       ...
       <!-- Register Account Start -->
        <div class="register-account ptb-100 ptb-sm-60">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="register-title">
                            <h3 class="mb-10">ĐĂNG KÍ TÀI KHOẢN</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form class="form-register" method="post" action="Register.java">
                            <fieldset>
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="f-name" placeholder="Họ và tên đệm" name="firstName">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="l-name"><span class="require">*</span>Tên</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="l-name" placeholder="Tên" name="lastName">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="number"><span class="require">*</span>Số điện thoại</label>
                                    <div class="col-md-10">
                                        <input type="number" class="form-control" id="number" placeholder="Số điện thoại" name="phoneNumber">
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    ...
                                    <div class="col-md-10">
                                        <input type="password" class="form-control" id="pwd" placeholder="Mật khẩu" name="password">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="pwd-confirm"><span class="require">*</span>Nhập lại mật khẩu</label>
                                    <div class="col-md-10">
                                        <input type="password" class="form-control" id="pwd-confirm" placeholder="Nhập lại mật khẩu" name="passwordCheck">
                                    </div>
                                </div>
                            </fieldset>
                            <div class="terms">
                                <div class="float-md-right">
                                    <input type="submit" value="XÁC NHẬN" class="return-customer-btn">
